                ...
                <div className="row">
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="mailto:contact@sellgo.com">
                                    contact@sellgo.com
                                </a>
                                <span>(+004) 912-2222-07</span>
                            </p>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">customercare@sellgo.com</a>
                                <span>(800) 843-4444</span>
                            </p>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">vendorsupport@sellgo.com</a>
